	...
	<div class="single">
		<div class="col-md-9 top-in-single">
			<div class="col-md-5 single-top">	
              ...
              <h3  id="price_<?php echo $product->id?>" style="padding-bottom: 15px; padding-top: 15px">$<?php echo $product->price ?></h3>
              <?php } else {?>
              <div class="row" style="padding-bottom: 15px; padding-top: 15px">
                <div class="col-md-12"><strike>$<?php echo $product->price ?></strike></div>
                <div class="col-md-12" style="color:#ff4d4d"><h3 id="price_<?php echo $product->id?>">$<?php echo $promotion_price?></h3></div>
              </div>
                ...
                foreach($relative_product as $rp):
                 ...
                 <div class="product-go">
                  ...
                  <div class="grid-product">
                    ...
                    <span class=" price-in"> $<?php echo $rp->price?></span>
                  </div>
                  <div class="clearfix"> </div>
                </div>
              <?php endforeach ?>
