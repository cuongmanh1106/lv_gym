...
<div class="card">
  <div class="card-header badge-info">
    <h4><i class="fa fa-edit"></i> Edit a promotion</h4>
  </div>
    ...
    <form id="form" method="POST" enctype="multipart/form-data" action="">
      <div class="container">
        ...
        <div class="row form-group">
          ...
          <div class="col-md-10"><input type="text" required="required" id="text-input" value="<?php echo $promotion->name?>" name="name" class="form-control"></div>
        ...
        <div class="row form-group">
          ...
          <div class="col-md-10"><input type="date" required="required" id="text-input" value="<?php echo $promotion->date_from?>" name="date_from" class="form-control"></div>
          <div class="col-md-1">(<span style="color:red">*</span>)</div>
        </div>

        <div class="row form-group">
          <div class="col-md-1"><label for="text-input" class=" form-control-label">Date To:</label></div>
          <div class="col-md-10"><input type="date" required="required" id="text-input" value="<?php echo $promotion->date_to?>" name="date_to" class="form-control"></div>
          <div class="col-md-1">(<span style="color:red">*</span>)</div>
        </div>
        ...
        <div class="row form-group">
          <div class="col-md-4"><img src="public/images/<?php echo $promotion->image ?>" alt=""></div>
        </div>
        ...
        <div class="row form-group">
          ...
          <div class="col-md-10"><textarea id="text-input" name="description" class="form-control ckeditor"><?php echo $promotion->description?></textarea></div>
        </div>
        ...
        <div class="form-group " style="text-align: center;">
          ...
          <button  type="button" class="btn btn-info" id="edit_promotion" name="edit_promotion"><i class="fa fa-thumbs-o-up"></i> Save</button>
...
<script type="text/javascript">
  $('#edit_promotion').on('click',function(){
    var html = '';
    var flag = true;
    var d = new Date();
    ...
    if(flag) {
     $('button[name="edit_promotion"]').attr("type", "submit");
   } else {
